...
class welcome extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('mdl_landing');
	}

	function index(){
		$primary = $this->mdl_landing->get_primary_info();
		$data['primary'] = $primary[0];
		$data['social'] = $this->mdl_landing->get_social_media();
		$data['stories'] = $this->mdl_landing->get_stories();
		$data['highlights'] = $this->mdl_landing->get_highlights();
		$data['sliders'] = $this->mdl_landing->get_all_sliders_active();
		$data['products'] = $this->mdl_landing->get_products();
		$data['recent_news'] = $this->mdl_landing->get_recent_news();
		$this->menu_handler->set_menu_frontend('home','Welcome',$data,2,3);
	}
