<?php
class Mdl_landing extends CI_Model{
	...
	function get_products(){
		$sql =" SELECT a.*, b.path_url, count(pa.parent) as item
				FROM products as a 
				LEFT JOIN images as b 
				ON a.product_id = b.product_id
                LEFT JOIN (SELECT  aa.product_id, aa.parent
                           FROM products as aa
                           WHERE aa.product_id<>0) as pa
				ON pa.parent = a.product_id
