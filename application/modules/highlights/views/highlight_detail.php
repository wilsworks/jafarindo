...
<section class="content-header">
    <h1>
    <?php echo $title; ?>
    <small><?php if(isset($new_highlight)) { echo '<i class="fa fa-chevron-right"></i>&nbsp;&nbsp;Add News'; } else { echo '<i class="fa fa-edit"></i>&nbsp;&nbsp;Edit News'; } ?></small>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active"><?php if(isset($new_highlight)) { echo '<i class="fa fa-plus"></i>&nbsp;&nbsp;Add News'; } else { echo '<i class="fa fa-edit"></i>&nbsp;&nbsp;Edit data'; } ?></li>
    </ol>
</section>
            ...
            <div class="box box-primary">	
                ...
                <div class="box-body">
					...
					<?php } ?>
                 	...
                 	<?php
						if(isset($new_highlight)) {
							echo form_open_multipart('highlights/add_highlight','class="form-horizontal" role="form"');
							$hidden_data_user = array(
								'new_highlight'=>true
							);
							echo form_hidden($hidden_data_user);
						} else {
							echo form_open_multipart('highlights/edit_highlight','class="form-horizontal" role="form"');
							$hidden_data_user = array(
								'id' => $data->id,
								'new_highlight'=> false
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" placeholder="Title"  name="title" <?php if(!isset($new_highlight)){ echo 'value="'.$data->title.'"'; } ?> autofocus>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">Description</label>
						<div class="col-sm-5">
							<textarea type="text" class="form-control"  placeholder="Content of Highlight" name="description" ><?php if(!isset($new_highlight)){ echo $data->description; } ?></textarea>
						</div>
					</div>
