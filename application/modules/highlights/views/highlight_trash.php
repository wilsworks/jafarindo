                    ...
                    <div class="pull-right">
                        <a href="#" rel="tooltip-top" title="Restore">
                          <button class="btn btn-box-tool" >
                            <i class="fa fa-refresh text-blue" data-toggle="modal" data-target="#restoreMessage"  id="<?php echo site_url('highlights/highlight_crud/'.$row->id.'-5'); ?>" onClick="restore_msg(this);"> Restore</i>
                          </button>
                        </a>

                        <a href="#" rel="tooltip-top" title="Permanent Delete">
                          <button class="btn btn-box-tool" >
                            <i class="fa fa-trash text-danger" data-toggle="modal" data-target="#deleteMessage"  id="<?php echo site_url('highlights/highlight_crud/'.$row->id.'-6'); ?>" onClick="sendimg(this);"> Delete</i>
                          </button>
                        </a>
