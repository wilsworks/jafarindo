    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box box-info">
				...
				<?php } ?>
        <a href="<?php echo site_url('settings/settings_sosmed/0-1') ?>" class="btn btn-primary" role="button"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo strtoupper($title); ?> BARU</a><br><br>
                    ...
                    <tbody>
                     	<?php $i=1;foreach ($daftar as $row){?>
								<tr>
									...
									<a href="<?php echo site_url('settings/settings_sosmed/'.$row->id.'-2'); ?>" rel="tooltip-top" title="Edit">
										<i class="fa fa-pencil"></i>
									</a>&nbsp;
  								 <a href="#" rel="tooltip-top" title="Permanent Delete">
                      <button class="btn btn-box-tool" >
                        <i class="fa fa-trash text-danger" data-toggle="modal" data-target="#deleteMessage"  id="<?php echo site_url('settings/settings_sosmed/'.$row->id.'-3'); ?>" onClick="sendimg(this);"> Delete</i>
                      </button>
                    </a>
											<?php } else {
												echo "N/A";
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <p class="error-text"><i class="fa fa-exclamation-triangle fa-2x"></i>&nbsp;&nbsp;&nbsp;Are you sure you want to delete permanent the Social Media item?</p>
                  </div>
