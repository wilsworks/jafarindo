      ...
      <div class="box box-info">
        ...
        <div class="box-body">
          <?php if(!empty($status)){ ?>
				  ...
				  <?php } ?>
           <a href="<?php echo site_url('sliders/sliders_crud/0-1') ?>" class="btn btn-primary" role="button"><i class="fa fa-plus"></i>&nbsp;&nbsp;NEW <?php echo strtoupper($title); ?></a><br><br>
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                  ...
                  <td>
                    ...
                    <p>
                      <?php
                        if(strlen($row->description)>350){
                            echo substr($row->description,0,350).'...'; 
                        }else{
                    ...
                    <p>
                      <?php
                       echo $row->start_publish.' - ';
                       if($row->end_publish==''){
                        echo 'Now';
                        }else{
                        echo $row->end_publish;
                        }
                      ?>
                    </p>
                    <?php if($row->start_publish=='A'){?> 
                    ...
                    <div class="pull-right">
                        <a href="<?php echo site_url('sliders/sliders_crud/'.$row->id.'-2'); ?>" rel="tooltip-top" title="Edit">
                        ...
                        <a href="#" rel="tooltip-top" title="Delete">
                          <button class="btn btn-box-tool" >
                            <i class="fa fa-trash text-orange" data-toggle="modal" data-target="#deleteMessage"  id="<?php echo site_url('sliders/sliders_crud/'.$row->id.'-3'); ?>" onClick="sendimg(this);"> Delete</i>
                          </button>
                        </a>
