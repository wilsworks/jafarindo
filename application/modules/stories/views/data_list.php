      ...
      <div class="box box-info">
        ...
        <div class="box-body">
          <?php if(!empty($status)){ ?>
				  ...
				  <?php } ?>
           <a href="<?php echo site_url('stories/stories_crud/0-1') ?>" class="btn btn-primary" role="button"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo strtoupper($title); ?> BARU</a><br><br>
              ...
              <tbody>
                  ...
                  <td>
                    ...
                    <div class="pull-right">
                        <a href="<?php echo site_url('stories/stories_crud/'.$row->story_id.'-2'); ?>" rel="tooltip-top" title="Edit">
                        ...
                        <a href="#" rel="tooltip-top" title="Delete">
                          <button class="btn btn-box-tool" >
                            <i class="fa fa-trash text-orange" data-toggle="modal" data-target="#deleteMessage"  id="<?php echo site_url('stories/stories_crud/'.$row->story_id.'-3'); ?>" onClick="sendimg(this);"> Delete</i>
                          </button>
                        </a>
