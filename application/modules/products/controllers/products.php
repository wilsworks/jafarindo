...
class products extends CI_Controller {
	...
	function index(){
		$primary = $this->mdl_content->get_primary_info();
		$data['primary'] = $primary[0];
		$data['social'] = $this->mdl_content->get_social_media();
		$data['stories'] = $this->mdl_content->get_stories();
		$data['product'] = $this->mdl_content->get_product(2);
		// print_r($data);
		$this->menu_handler->set_menu_frontend('products','Products',$data,2,3);
	}
	...
	function product_list($id){
		...
		$data['social'] = $this->mdl_content->get_social_media();
		$data['stories'] = $this->mdl_content->get_stories();
		$data['product'] = $this->mdl_content->get_product($id);
		$this->menu_handler->set_menu_frontend('products','Products',$data,2,3);
	}
	...
	function product_detail($id){
		...
		// spesific product
		$data['product'] = $this->mdl_content->get_product_spesific($id);
		

		// untuk load images
		$data['images'] = $this->mdl_content->get_product_images($id);
		$detail = $this->mdl_content->get_product_detail($id);
		$data['detail'] = $detail[0];
		$data['others'] = $this->mdl_content->get_product($detail[0]->parent,'3');

		// print_r($data['others']);
		// die();
		$this->menu_handler->set_menu_frontend('product_detail','Product Detail',$data,2,3);
	}
