...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li ><a href="<?php echo site_url('familys/familys_crud/0-4')?>" class="text-primary" rel="tooltip-top" title="Goto <?php echo $title; ?>"><?php echo $title; ?></a></li>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <a href="<?php echo site_url('familys/familys_crud/'.$row->parentId.'-5'); ?>" rel="tooltip-top" title="Restore familys">
                        <i class="fa fa-undo "></i>
                      </a>&nbsp;&nbsp;
                      <a href="#" rel="tooltip-top" title="Delete Permanent">
                        
                        <i class="fa fa-remove" data-toggle="modal" data-target="#deleteMessage"  id="<?php echo site_url('familys/familys_crud/'.$row->parentId.'-6'); ?>" onClick="sendimg(this);"></i>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p class="error-text"><i class="fa fa-exclamation-triangle fa-2x"></i>&nbsp;&nbsp;&nbsp;Are you sure you want to permanent delete this familys?</p>
              </div>
