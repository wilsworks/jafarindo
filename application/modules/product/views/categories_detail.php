...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><?php if(isset($new_project)) { echo '<i class="fa fa-user"></i>&nbsp;&nbsp;New driver'; } else { echo '<i class="fa fa-edit"></i>&nbsp;&nbsp;Edit driver'; } ?></li>
    </ol>
</section>
        ...
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Photo's Detail</h3>
					...
					<?php } ?>
                 	...
                 	<?php
						...
						// }
                 		...
                 		if(isset($new_project)) {
							echo form_open_multipart('product/do_upload','class="form-horizontal" role="form"');
							$hidden_data_user = array(
								'category' => $category,
								'new_project'=>true
							);
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										<p class="error-text"><i class="fa fa-exclamation-triangle fa-2x"></i> Are you sure you want to delete the project?</p>
									</div>
									<div class="modal-footer">
					                    <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Cancel</button>
					                    <a href="<?php echo site_url('project/photography/'.$project->id.'-3'); ?>"><button type="button" class="btn btn-outline">Delete</button></a>
					                </div>
