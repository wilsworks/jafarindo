    ...
    <div class="col-xs-12">
      <div class="box box-info">
        ...
        <div class="box-body">
          ...
          <?php } ?>
           <a href="<?php echo site_url('product/categories_crud/0-1') ?>" class="btn btn-primary" role="button"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo strtoupper($title); ?> BARU</a><br><br>
              ...
              <tbody>
                ...
                <?php $i=1;foreach ($daftar as $row){?>
                  <div class="col col-md-3">
                    <img class="img-responsive" src="<?php if(!empty($row->path_url)){echo base_url().'data/product/image/'.$row->path_url;} else {echo base_url().'data/product/image/item_default.jpg' ;} ?>" alt="Photo">
                    ...
                    <p>
                      <div class="pull-right">
                        <a href="<?php echo site_url('product/categories_crud/'.$row->product_id.'-2'); ?>" rel="tooltip-top" title="Edit">
                        ...
                        <a href="#" rel="tooltip-top" title="Delete">
                          <button class="btn btn-box-tool" >
                            <i class="fa fa-trash text-orange" data-toggle="modal" data-target="#deleteMessage"  id="<?php echo site_url('product/categories_crud/'.$row->product_id.'-3'); ?>" onClick="sendimg(this);"> Delete</i>
                          </button>
                        </a>
                      </div>
                    </p>
