...
class welcome extends CI_Controller {
	...
	{
		// Manatory
		$data['about'] = $this->mdl_landing->get_company_profile('about');
		$data['about_short'] = $this->mdl_landing->get_company_profile('about_short');
		$contact= $this->mdl_landing->get_company_profile('kontak');
		$data['contact'] = $contact->value;
		$data['social_media'] = $this->mdl_landing->get_social_media();
		//perpages
		$data['recent_news'] = $this->mdl_landing->get_recent_news();
		$data['slide'] = $this->mdl_landing->get_slide_data();
		// print_r($data['slide']);die();
